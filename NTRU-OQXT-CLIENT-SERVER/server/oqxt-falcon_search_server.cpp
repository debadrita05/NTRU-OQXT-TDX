#include "oqxt-falcon_search_server.h"
...
int MGDB_QUERY(unsigned char *RES, unsigned char *BIDX, unsigned char *JIDX, unsigned char *LBL)
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    if (!val) {
	            std::cerr << "[MGDB_QUERY] Key not found in Redis: " << s << std::endl;
		            return -1;  // or 1
    }
    ///////////////////////////////////////////////////////////////////////
	...
	*/
	...
	while(true){
		...
		*/
		...
		n_vec = 2;  // Now we have valid data;
	
	recv_all(newsockfd, row_vec, 16 * n_vec);  // assuming n_vec = number of keywords
