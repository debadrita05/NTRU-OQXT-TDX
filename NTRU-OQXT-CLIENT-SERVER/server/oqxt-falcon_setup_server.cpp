#include "oqxt-falcon_setup_server.h"
	...
	recv_all(socket_fd, (unsigned char*)&n_row_ids, sizeof(n_row_ids));
	    ...
	    /*
            ...
            */
            ...
            unsigned char db_in_val_buf[2082];
            recv_all(socket_fd, db_in_key_buf, 32);
            recv_all(socket_fd, db_in_val_buf, 2082);

			db_in_key = std::string(reinterpret_cast<const char*>(db_in_key_buf), 32);
            db_in_val = std::string(reinterpret_cast<const char*>(db_in_val_buf), 2082);
